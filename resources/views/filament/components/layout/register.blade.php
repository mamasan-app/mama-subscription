...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div class="fi-simple-layout flex min-h-screen flex-col items-center bg-gray-100 dark:bg-gray-900 ">
        @if (filament()->auth()->check())
            <div class="absolute end-0 top-0 flex h-16 items-center gap-x-4 pe-10 md:pe-6 lg:pe-8">
    ...
    <main
        @class([
            'fi-simple-main my-16 w-full bg-white dark:bg-gray-800 p-2 mg-10 rounded-lg shadow-lg',
            match ($maxWidth ?? null) {
